...
void processGyroData() {
  ...
  elapsed_time = (time - prev_error) / 1000; 
  rotX = gyroX/131.0;
...
void find_gyroangle() {
  gyro_angle[0] = rotX * elapsed_time;
  gyro_angle[1] = rotY * elapsed_time;
}
...
void printData() {
  ...
  //Prints the Gyro Angle.
  Serial.print(gyro_angle[1]);
  //Prints the Gyro Angle.
  Serial.print(pwm_left);
  //Prints the left motor pwm.
  Serial.print(pwm_right);
  //Prints the right motor pwm.
}
